  ...
  try {
    ...
    if (email.value.trim() !== user.email) {
      try {
        ...
        alert("Email was not updated. Please log in again before changing your email.");
      }
    }
    ...
    if (password.value.trim() !== "") {
      try {
        ...
        alert("Password was not updated. Please log in again before changing your password.");
      }
    }
